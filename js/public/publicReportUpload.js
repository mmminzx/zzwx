...
var ZYFILE = {
    ...
    funUploadFiles: function () {
        ...
        console.log("111length"+this.uploadFile);
        //$.each(this.uploadFile, function (k, v) {
        //    //console.log(v);
        ...
        if (this.uploadFile.length > 0) {
            ...
            http://112.81.63.243/ZZWaterDB/sharedService/Ashx_Question.ashx?method=reportQuestion&token=test&riverCode=4132D548-B731-4A2E-9EBE-48FABDB8FAC1&riverName=test&reportUserName=test&qType=1&lon=120.555708&lat=30.921256&address=test&rType=test&emergency=test&content=test&imgs=test&videos=test&industryImg1=test&industryImg2=test&industryImg3=test&industryImg4=test&floater=test&ilegal=test&speed=test&guardrail=test&sewage=test&riverStatus=test&maintain=test
        ...
        // /*--------------------传图同时也传参----------------------------*/
        // self.url = svcHeader+"Ashx_Question.ashx?method=reportQuestion&token=test&riverCode="+riverId+"&riverName=test&reportUserName=test&qType=1&lon="+lon+"&lat="+lat+"&address=test&rType=test&emergency=test&content="+ $("#question").val()+"&imgs=test&videos=test&industryImg1=test&industryImg2=test&industryImg3=test&industryImg4=test&floater=test&ilegal=test&speed=test&guardrail=test&sewage=test&riverStatus=test&maintain=test",
        //     /*--------------------传图同时也传参----------------------------*/
        ...
        console.log("Ashx_Question.ashx?method=reportQuestion&token=test&riverCode="+getParam("OID")+"&riverName="+getParam("riverName")+"&reportUserName=公众&qType=1&lon="+lon+"&lat="+lat+"&address=test&rType=test&emergency=test&content="+ $("#question").val()+"&imgs="+images+"&videos=test&industryImg1=test&industryImg2=test&industryImg3=test&industryImg4=test&floater=test&ilegal=test&speed=test&guardrail=test&sewage=test&riverStatus=test&maintain=test");
        $.ajax({
            type: "get",
            url: svc_own + "Ashx_Question.ashx?method=reportQuestion&token=&riverCode="+getParam("OID")+"&riverName="+getParam("riverName")+"&reportUserName=公众&qType=1&lon="+lon+"&lat="+lat+"&address=test&rType=异常上报&emergency=test&content="+ $("#question").val()+"&imgs="+images+"&videos=test&industryImg1=test&industryImg2=test&industryImg3=test&industryImg4=test&floater=test&ilegal=test&speed=test&guardrail=test&sewage=test&riverStatus=test&maintain=test",
            dataType: 'jsonp',
            jsonp: 'callback',
            data: null,
        ...
        // $.ajax({
        //     type: "post",
        //     url: svc_own + "Ashx_System.ashx?method=uploadFile&token=b9813978d9674a60aeb2d8078fc52f28&file="+formdata,
        //     dataType: 'jsonp',
        //     crossDomain: true,
        //     jsonp: 'callback',
        //     // data: {"file":formdata},
    ...
    funUploadFile: function (file) {
        ...
        // images="/9d2e0454-ba56-4daf-8207-79fd3408fad7.png";
        console.log("Ashx_Question.ashx?method=reportQuestion&token=test&riverCode="+getParam("riverId")+"&riverName="+getParam("riverName")+"&reportUserName=公众&qType=1&lon="+lon+"&lat="+lat+"&address=test&rType=test&emergency=test&content="+ $("#question").val()+"&imgs="+images+"&videos=test&industryImg1=test&industryImg2=test&industryImg3=test&industryImg4=test&floater=test&ilegal=test&speed=test&guardrail=test&sewage=test&riverStatus=test&maintain=test");
        $.ajax({
            type: "get",
            url: svc_own + "Ashx_Question.ashx?method=reportQuestion&token=&riverCode="+getParam("OID")+"&riverName="+getParam("riverName")+"&reportUserName=公众&qType=1&lon="+lon+"&lat="+lat+"&address=test&rType=异常上报&emergency=test&content="+ $("#question").val()+"&imgs="+images+"&videos=test&industryImg1=test&industryImg2=test&industryImg3=test&industryImg4=test&floater=test&ilegal=test&speed=test&guardrail=test&sewage=test&riverStatus=test&maintain=test",
            dataType: 'jsonp',
        ...
        if (self.uploadInput) {
            ...
            this.uploadInput.addEventListener("click", function (e) {
                ...
                if ($("#photoContent").val() == '') {
                    ...
                    $("#myPopup1").html(" <a href=\"#\" data-rel=\"back\" class=\"ui-btn ui-corner-all ui-shadow ui-btn ui-icon-delete ui-btn-icon-notext ui-btn-right\">关闭</a><h2 style=\"text-align:center;\">注意！</h2><p>最多上传3张图片，点击图片可删除或编辑。请重试！</p>")
                    $("#myPopup1").popup('open');
                } else {
