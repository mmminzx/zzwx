...
$(function () {
                ...
                if (result.isOK) {
                    ...
                    for (var i=0;i<arr.length;i++)
                    {
                        ...
                        $("#thelist").append('<li style="list-style: none;margin: 0 0 20px 0;border-bottom:1px solid #616161;padding-left: 0px;height: 32vw" onclick="liclick(\''+i+'\')">'
                            ...
                            +'<label style="width: 100%;height: 20px;font-size: 16px;color: #8a8a8a;margin: 0px;position:relative;line-height: 20px;display: -webkit-box;-webkit-box-orient: vertical;-webkit-line-clamp: 1;text-overflow:ellipsis ;overflow:hidden">'+"负责人："+userNames+'</label>'
                            +'</div>'
        ...
        $("#fileSubmit").click(function(event) {
            ...
            if (selectedRivers.length==0)
            {
                ...
                localStorage.entrustRivers = JSON.stringify(selectedRivers);

                window.location.href="SelectedPeople.html";
            }
