...
//            30.9124371686,120.5094498200
    ...
    //     obj1.style.cssText = "display:block";
    // })
    // http://112.81.63.243/ZZWaterDB/sharedService/Ashx_Enterprise.ashx?method=getWorkPhotoPageList&riverCode=4132D548-B731-4A2E-9EBE-48FABDB8FAC1&page=1&pageSize=2
...
function uploadData() {
    ...
    var  userName=$.cookie('zzwxUserName');
    $("#myPopup").popup("close");
    console.log("Ashx_Enterprise.ashx?method=reportWorkPhoto&token="+token+"&riverCode="+riverId+"&riverName="+riverName+"&qType=1&lon="+lon+"&lat="+lat+"&address="+riverName+"&content="+ $("#question").val()+"&imgs="+images+"&villageCode="+villageCode+"&villageName="+villageName+"&signCode="+signid);
    $.ajax({
        type: "get",
        url: svc_own + "Ashx_Enterprise.ashx?method=reportWorkPhoto&token="+token+"&reportUserName="+userName+"&riverCode="+riverId+"&riverName="+riverName+"&qType=1&lon="+lon+"&lat="+lat+"&address="+riverName+"&content="+ $("#question").val()+"&imgs="+images+"&villageCode="+villageCode+"&villageName="+villageName+"&signCode="+signid,
        dataType: 'jsonp',
        jsonp: 'callback',
        data: null,
        success: function (result) {
