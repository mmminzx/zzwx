...
var ZYFILE = {
    ...
    funUploadFiles: function () {
        ...
        console.log("Ashx_Question.ashx?method=reportQuestion&token="+token+"&riverCode="+getParam("OID")+"&riverName="+getParam("riverName")+"&reportUserName="+userName+"&qType=1&lon="+lon+"&lat="+lat+"&address=test&rType="+selectedtype+"&emergency="+emergency+"&content="+ $("#question").val()+"&imgs="+images+"&videos=test&industryImg1=test&industryImg2=test&industryImg3=test&industryImg4=test&floater=test&ilegal=test&speed=test&guardrail=test&sewage=test&riverStatus=test&maintain=test");
        $.ajax({
            type: "get",
            url: svc_own + "Ashx_Question.ashx?method=reportQuestion&token="+token+"&riverCode="+getParam("OID")+"&riverName="+getParam("riverName")+"&reportUserName="+userName+"&qType=1&lon="+lon+"&lat="+lat+"&address=test&rType="+selectedtype+"&emergency="+emergency+"&content="+ $("#question").val()+"&imgs="+images+"&videos=test&industryImg1=test&industryImg2=test&industryImg3=test&industryImg4=test&floater=test&ilegal=test&speed=test&guardrail=test&sewage=test&riverStatus=test&maintain=test",
            dataType: 'jsonp',
            jsonp: 'callback',
            data: null,
