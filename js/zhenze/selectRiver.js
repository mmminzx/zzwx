        ...
        success: function (result) {
            ...
            if (result.isOK) {
                ...
                for (var i=0;i<arr.length;i++)
                {
                    ...
                    //     +'</li>'
                    // );
                    $("#thelist").append('<li style="height: 70px;list-style: none;border-bottom:1px solid #616161;padding-left: 0px;" onclick="liclickselected(\'' +i+ '\')">'
                        + '<div style="width: 90%;height: 80px;margin-left: 10%;">'
                        + '<div style="width: 100%;height: 80px">'
                        + '<label style="line-height: 60px;width: 70%;float:left;font-size: 20px;color: #3a3a3a;margin-top: 0px">' + arr[i].name + '</label>'
                        +'</div.>'
                        +'<div style="width: 20%;height: 60px;margin-top: 10px;float: right;">'
                        +'<img style="width: 45px;float: right" src="../images/箭头.png">'
                        + '</div>'
                        + '</li>'
                    );
