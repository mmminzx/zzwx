...
var ZYFILE = {
    ...
    funUploadFiles: function () {
        ...
        /*--------------------传图同时也传参----------------------------*/
        self.url = "http://58.241.38.107:8090/NJXService/Data/EventUpload.ashx?clientID=1"  + "&photoContent=" + $("#photoContent").val() + "&districtID=01",
            /*--------------------传图同时也传参----------------------------*/
    ...
    funUploadFile: function (file) {
        ...
        /*--------------------传图同时也传参----------------------------*/
        self.url = "http://58.241.38.107:8090/NJXService/Data/EventUpload.ashx?clientID=01" + "&photoContent=" + $("#photoContent").val() + "&districtID=" + $("#districtID").val() ,
