...
var ZYFILE = {
    ...
    funUploadFiles: function () {
        ...
        if (chulitype=="")
        {
            $("#myPopup1").html(" <h2 style=\"text-align:center;\">提示</h2><p>请选择现在处理类型</p>")
            $("#myPopup1").popup('open');
        ...
        else
        {
            ...
            // console.log("Ashx_Enterprise.ashx?method=reportEnterprise&token="+token+"&riverCode="+getParam("OID")+"&riverName="+getParam("riverName")+"&reportUserName="+userName+"&qType=2&lon="+lon+"&lat="+lat+"&address="+riverName+"&rType="+selectedtype+"&emergency="+emergency+"&processContent="+ $("#question").val()+"&imgs="+images+"&videos=test&industryImg1=test&industryImg2=test&industryImg3=test&industryImg4=test&floater=test&ilegal=test&speed=test&guardrail=test&sewage=test&riverStatus=test&maintain=test");
            $.ajax({
                type: "get",
                url: svc_own + "Ashx_Enterprise.ashx?method=reportEnterprise&token="+token+"&riverCode="+riverId+"&riverName="+riverName+"&reportUserName="+userName+"&lon="+lon+"&lat="+lat+"&address="+riverName+"&imgs="+images+"&enterpriseName="+$("#faname").val()+"&leader="+$("#pername").val()+"&phone="+$("#phone").val()+"&buildDate="+$("#signInTime").val()+"&portDistance="+$("#distance").val()+"&sewageDisposalType="+chulitype+"&sewageDisposalTypeName="+chulitype,
                dataType: 'jsonp',
                jsonp: 'callback',
                data: null,
    ...
    funUploadFile: function (file) {
        ...
        console.log("Ashx_Question.ashx?method=reportQuestion&token="+token+"&riverCode="+riverId+"&riverName="+riverName+"&reportUserName="+userName+"&qType=2&lon="+lon+"&lat="+lat+"&address=test&rType="+selectedtype+"&rTypeName="+selectedtypeName+"&emergency="+emergency+"&processContent="+ $("#question").val()+"&imgs="+images+"&videos=test&industryImg1=test&industryImg2=test&industryImg3=test&industryImg4=test&floater=test&ilegal=test&speed=test&guardrail=test&sewage=test&riverStatus=test&maintain=test");
        $.ajax({
            type: "get",
            url: svc_own + "Ashx_Enterprise.ashx?method=reportEnterprise&token="+token+"&riverCode="+riverId+"&riverName="+riverName+"&reportUserName="+userName+"&lon="+lon+"&lat="+lat+"&address="+riverName+"&imgs="+images+"&enterpriseName="+$("#faname").val()+"&leader="+$("#pername").val()+"&phone="+$("#phone").val()+"&buildDate="+$("#signInTime").val()+"&portDistance="+$("#distance").val()+"&sewageDisposalType="+chulitype+"&sewageDisposalTypeName="+chulitype,
            dataType: 'jsonp',
